...
var less_count = 200;
var abstract_list = [];
var abstract_nodes = document.getElementsByClassName('abstract');
for (var i = 0; i < abstract_nodes.length; i++) {
  var text = abstract_nodes[i].innerText;
  if (text.length > less_count) {
    /* Replace innerText with two spans*/
    abstract_nodes[i].innerText = ''

    var less_text = document.createElement('span');
    ...
    var full_text = document.createElement('span');
